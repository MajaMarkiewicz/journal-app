...
const JournalFilters: React.FC = () => {
  ...
  return (
    <div className="mb-8">
      ...
      >
        <div data-testid="start-date-filter">
        ...
        <div data-testid="end-date-filter">
        ...
        <div data-testid="category-filter" className="col-span-2">
        ...
        <div className="flex items-center" data-testid="important-filter">
